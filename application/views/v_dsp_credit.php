        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
			...
			<p class="mb-4">Halaman untuk melakukan input Kas Credit pada Kas DSP - PSB</p>
          <!-- Content Row -->
          <div class="row">
            <!-- Area Chart -->
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
               ...
               <form class="user" action="<?= site_url("dsp/do_add_credit/")?>" method="post" enctype="multipart/form-data">
