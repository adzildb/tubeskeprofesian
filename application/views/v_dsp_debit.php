          ...
          <div class="row">
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
               ...
               <form class="user" action="<?= site_url("dsp/do_add_debit/")?>" method="post" enctype="multipart/form-data">
			   ...
			   <div class="form-group">
				  <div class="col-sm-9 mb-3 mb-sm-0">
				  <h6 class="h6 font-weight-bold  text-gray-900">Kas Debit</h6> <input type="number" class="form-control" id="exampleFirstName" name="nominal_debit" placeholder="Nominal">
                  </div>
                </div>
				<div class="form-group">
				  <div class="col-sm-9 mb-3 mb-sm-0">
